...
for dim in dims:
    ...
    mean_file = os.getcwd() + '/results/pca_dims/mean{}.txt'.format(dim)
    std_file = os.getcwd() + '/results/pca_dims/std{}.txt'.format(dim)
...
plt.savefig(os.getcwd() + '/results/plots/dim_pca_mstd.png',bbox_inches='tight')
plt.savefig(os.getcwd() + '/results/plots/dim_pca_mstd.pdf',bbox_inches='tight')

...
for depth in depths:
    ...
    filename = os.getcwd() + '/results/raw_results/pca_dims/images{}.pt'.format(depth)
...
plt.savefig( os.getcwd() + '/results/plots/pdf/it200_pca.pdf')
plt.savefig( os.getcwd() + '/results/plots/png/it200_pca.png')
plt.show()
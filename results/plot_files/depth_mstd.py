...
for depth in depths:
    ...
    mean_file = os.getcwd() + '/results/raw_results/depth/mean{}.txt'.format(depth)
    std_file = os.getcwd() + '/results/raw_results/depth/std{}.txt'.format(depth)
...
plt.savefig(os.getcwd() + '/results/plots/pdf/depthmstd.png',bbox_inches='tight')
plt.savefig(os.getcwd() + '/results/plots/png/depthmstd.pdf',bbox_inches='tight')

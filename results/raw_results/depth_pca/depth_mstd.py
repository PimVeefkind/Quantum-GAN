...
for depth in depths:
    ...
    mean_file = os.getcwd() + '/results/depth_pca/mean{}.txt'.format(depth)
    std_file = os.getcwd() + '/results/depth_pca/std{}.txt'.format(depth)
...
plt.savefig(os.getcwd() + '/results/plots/depthmstd_pca.png',bbox_inches='tight')
plt.savefig(os.getcwd() + '/results/plots/depthmstd_pca.pdf',bbox_inches='tight')
